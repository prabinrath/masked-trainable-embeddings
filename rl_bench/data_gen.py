...
class ReverseTrajGen():
    ...
    def get_demo(self, Task):
        ...
        demo_dict = dict(
            ...
            left_shoulder_rgb=[], left_shoulder_mask=[], left_shoulder_depth=[], left_shoulder_point_cloud=[],
            right_shoulder_rgb=[], right_shoulder_mask=[], right_shoulder_depth=[], right_shoulder_point_cloud=[],
            overhead_rgb=[], overhead_mask=[], overhead_depth=[], overhead_point_cloud=[],
            wrist_rgb=[], wrist_mask=[], wrist_depth=[], wrist_point_cloud=[],
            joint_positions=[],
            joint_velocities=[],
            gripper_pose=[],
            gripper_open=[]
